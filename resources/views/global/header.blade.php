<header id="page-header">
        ...
        <div>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn btn-dual" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="d-none d-sm-inline-block">{{ auth()->user()->short_name }}</span>
    ...
    <div id="page-header-search" class="overlay-header bg-primary">
        <div class="content-header">
            <form class="w-100" action="{{ route('szukaj') }}" method="POST">
                @csrf
                <div class="input-group">
                    ...
                    <input type="text" class="form-control border-0" placeholder="Szukaj lub naciśnij ESC.." id="page-header-search-input" name="page-header-search-input">
                </div>
            </form>
       </div>
    </div>
