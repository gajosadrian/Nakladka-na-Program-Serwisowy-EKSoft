...
class Status extends Model
{
    ...
    private static $PROPERTIES = [
        ...
        38 => [ 'icon' => 'far fa-comment-dots', 'color' => 'info' ], 39 => [ 'icon' => 'fa fa-cart-plus', 'color' => 'secondary' ], 40 => [ 'icon' => 'fa fa-calculator', 'color' => 'secondary' ],
        41 => [ 'icon' => 'fa fa-question', 'color' => 'secondary' ], 42 => [ 'icon' => 'fa fa-phone', 'color' => 'secondary' ], 43 => [ 'icon' => 'fa fa-phone', 'color' => 'success' ],
    ];
    public const AKTYWNE_IDS = [
        self::ZLECENIE_WPISANE_ID,
        self::GOTOWE_DO_WYJAZDU_ID,
        self::UMOWIONO_ID,
        self::PREAUTORYZACJA_ID,
